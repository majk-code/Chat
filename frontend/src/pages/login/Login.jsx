...
const Login = () => {
  ...
  return (
    <div className="login">
      ...
      <img className='logomain' src={logo_image} alt="" />
      <h1>LOGOWANIE</h1>
      <span className='subtitle'>Zaloguj się i rozpocznij chat online.</span>
