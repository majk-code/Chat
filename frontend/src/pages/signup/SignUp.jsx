...
const SignUp = () => {
  ...
  return (
    <div className="signup">
      ...
      <h1>Utwórz konto</h1>
      <span className="subtitle">Zarejestruj się i dołącz do społeczności</span>
